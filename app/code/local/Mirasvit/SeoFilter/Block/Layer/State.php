...
if (Mage::helper('mstcore')->isModuleInstalled('Aitoc_Aitmanufacturers') && class_exists('Aitoc_Aitmanufacturers_Block_Rewrite_CatalogLayerState')) {
    ...
    abstract class Mirasvit_SeoFilter_Block_Layer_State_Abstract extends Mirasvit_SeoFilter_Block_Layer_State_Amasty_Pure {

    }
}

class Mirasvit_SeoFilter_Block_Layer_State extends Mirasvit_SeoFilter_Block_Layer_State_Amasty_Pure
{
    /**
