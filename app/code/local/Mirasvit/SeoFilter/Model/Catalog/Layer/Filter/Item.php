...
if (Mage::helper('mstcore')->isModuleInstalled('GoMage_Navigation') && class_exists('GoMage_Navigation_Model_Layer_Filter_Item')) {
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends GoMage_Navigation_Model_Layer_Filter_Item {
    }
} elseif (Mage::helper('mstcore')->isModuleInstalled('Amasty_Shopby') && class_exists('Amasty_Shopby_Model_Catalog_Layer_Filter_Item')) {
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends Amasty_Shopby_Model_Catalog_Layer_Filter_Item {
    }
    ...
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends Amasty_Xlanding_Model_Catalog_Layer_Filter_Item {
    }
    ...
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends Fishpig_AttributeSplash_Model_Layer_Filter_Item {
    }
    ...
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends EM_LayeredNavigation_Model_Catalog_Filter_Item {
    }
} elseif (Mage::helper('mstcore')->isModuleInstalled('Catalin_SEO') && class_exists('Catalin_SEO_Model_Catalog_Layer_Filter_Item')) {
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends Catalin_SEO_Model_Catalog_Layer_Filter_Item {
    }
} else {
    abstract class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure extends Mage_Catalog_Model_Layer_Filter_Item {
    }
}

class Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item extends Mirasvit_SeoFilter_Model_Catalog_Layer_Filter_Item_Amasty_Pure {
