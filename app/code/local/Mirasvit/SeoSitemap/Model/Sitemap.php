...
if (Mage::helper('mstcore')->isModuleInstalled('Magpleasure_Blog') && class_exists('Magpleasure_Blog_Model_Sitemap')) {
    abstract class Mirasvit_SeoSitemap_Model_Sitemap_Amasty_Pure extends Magpleasure_Blog_Model_Sitemap {
    }
} elseif (Mage::helper('mstcore')->isModuleInstalled('Fishpig_Wordpress') && class_exists('Fishpig_Wordpress_Model_Sitemap_Sitemap')) {
    abstract class Mirasvit_SeoSitemap_Model_Sitemap_Amasty_Pure extends Fishpig_Wordpress_Model_Sitemap_Sitemap {
    }
} else {
    abstract class Mirasvit_SeoSitemap_Model_Sitemap_Amasty_Pure extends Mage_Sitemap_Model_Sitemap {
    }
}

class Mirasvit_SeoSitemap_Model_Sitemap extends Mirasvit_SeoSitemap_Model_Sitemap_Amasty_Pure
{
    protected $io;
