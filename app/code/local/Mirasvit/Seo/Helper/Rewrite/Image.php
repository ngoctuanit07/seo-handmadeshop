...
if (Mage::helper('mstcore')->isModuleInstalled('EM_Cloudzoom') && class_exists('EM_Cloudzoom_Helper_Image')) {
   abstract class Mirasvit_Seo_Helper_Rewrite_Image_Amasty_Pure extends EM_Cloudzoom_Helper_Image {
   }
} elseif (Mage::helper('mstcore')->isModuleInstalled('Amasty_Shopby') && class_exists('Amasty_Shopby_Helper_Image')) {
    abstract class Mirasvit_Seo_Helper_Rewrite_Image_Amasty_Pure extends Amasty_Shopby_Helper_Image {
   }
} elseif (Mage::helper('mstcore')->isModuleInstalled('Bintime_Sinchimport') && class_exists('Bintime_Sinchimport_Helper_Image')) {
    abstract class Mirasvit_Seo_Helper_Rewrite_Image_Amasty_Pure extends Bintime_Sinchimport_Helper_Image {
    }
} elseif (Mage::helper('mstcore')->isModuleInstalled('Iceshop_Icecatlive') && class_exists('Iceshop_Icecatlive_Helper_Catalog_Image')) {
    abstract class Mirasvit_Seo_Helper_Rewrite_Image_Amasty_Pure extends Iceshop_Icecatlive_Helper_Catalog_Image {
    }
} else {
    abstract class Mirasvit_Seo_Helper_Rewrite_Image_Amasty_Pure extends Mage_Catalog_Helper_Image {
    }
}

class Mirasvit_Seo_Helper_Rewrite_Image extends Mirasvit_Seo_Helper_Rewrite_Image_Amasty_Pure
{
