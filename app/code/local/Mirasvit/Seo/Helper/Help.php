...
class Mirasvit_Seo_Helper_Help extends Mirasvit_MstCore_Helper_Help
{
    protected $_help = array(
        'system' => array(
            ...
            'snippets_rich_snippets_color_config'                    => 'Add an attribute code of the color. If you want to add a few attributes, use the comma separator. For example: color, car_color <b>Leave the field empty, to do not use.</b>',
            'snippets_rich_snippets_weight_config'                   => 'If enabled, will add weight snippet. You can set to use kilogram or pound.',
            ...
            'snippets_rich_snippets_dimensional_unit'                => 'If use numeric value for dimension you can set dimensional unit. For example cm, mm, inch. <b>Leave the field empty, to do not use.</b>',
            ...
            'snippets_category_rich_snippets_rewiew_count_text'      => 'Text which will be specified in the block of "Category Rich Snippets", after the review count.',
            ...
            'snippets_is_organization_snippets'                      => 'If enabled, add Organization snippets.',
