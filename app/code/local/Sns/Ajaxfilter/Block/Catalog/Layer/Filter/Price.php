	...
	public function getPriceDisplayType(){
		if($this->isTextBoxEnabled()){
			$html = '
				<div class="text-box">
					<div class="inner">
						<span class="price-from-symbol">'.$this->getCurrencySymbol().'</span>
						<input type="text" name="min" id="minPrice" class="priceTextBox price-from" value="'.$this->getCurrMinPrice().'"/>
						<div class="price-separator">-</div>
						<span class="price-from-symbol">'.$this->getCurrencySymbol().'</span>
						<input type="text" name="max" id="maxPrice" class="priceTextBox price-to" value="'.$this->getCurrMaxPrice().'"/>
						<button name="go" class="go filter-action">'.$this->getGoBtnText().'</button>
