...
class Sns_Facebook_Helper_Data extends Mage_Core_Helper_Abstract {
	...
	function get($attributes=array()){
		...
		$module_setting				= Mage::getStoreConfig("facebook_cfg/module_setting");
		$advanced 					= Mage::getStoreConfig("facebook_cfg/advanced");
	...
	public function getJQquery(){
		if (Mage::getStoreConfigFlag('slider_cfg/advanced/include_jquery')){
			if (null == Mage::registry('sns.jquery')){
				...
				return 'sns/facebook/js/jquery-1.7.2.min.js';
			}
		}
		return;
	}
	public function getJQqueryNoconflict(){
		if (Mage::getStoreConfigFlag('slider_cfg/advanced/include_jquery')){
			if (null == Mage::registry('sns.jquerynoconflict')){
				...
				return 'sns/facebook/js/sns.noconflict.js';
			}
		}
		return;
	}
